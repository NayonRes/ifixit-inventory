...
var expenseCategoryRouter = require("./routes/expenseCategoryRoute");
...
var saleAttachedProductRouter = require("./routes/saleAttachedProductRoute");
...
var transactionHistoryRouter = require("./routes/transactionHistoryRoute");
...
app.use("/api/v1/saleAttachedProduct", saleAttachedProductRouter);
